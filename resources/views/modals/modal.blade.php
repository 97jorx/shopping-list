		...
		<div class="max-w-2xl mx-auto">
			<div class="relative overflow-x-auto xl:overflow-x-hidden lg:overflow-x-hidden shadow-md sm:rounded-lg">
				<div class="p-4">
					...
					<div id="wrapper-search-box" class=" shadow-lg w-full relative z-10">
						<div id="loader" role="status" class="flex flex-wrap justify-center">
							<svg aria-hidden="true" class="hidden mr-2 w-16 h-16 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
				...
				<table id="table-list" class="z-10 w-full text-sm text-left text-gray-500 ">
