    ...
    <nav class='flex items-center flex-wrap mb-14 p-6 bg-blue-500 '>
        <div class='flex items-center flex-shrink-0 text-white px-10'>
          ...
          <div class="hidden w-full md:block md:w-auto" id="navbar-default">
            <ul class="flex flex-col md:flex-row md:space-x-8 md:space-y-0 sm:space-y-2 space-y-3  md:text-sm md:font-medium md:border-0 dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
              <li>
